    ...
    >
      <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-lg transform transition-all duration-300">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800">{t('edit_modal.title')}</h2>
        ...
        <form onSubmit={handleSave}>
          <div className="mb-4">
            <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-1">{t('edit_modal.name')}</label>
            <input
              type="text"
              id="name"
              name="name"
          ...
          <div className="mb-4">
            <label htmlFor="roles" className="block text-sm font-medium text-gray-700 mb-1">{t('edit_modal.roles')} (comma-separated)</label>
            <input
              type="text"
              id="roles"
              name="roles"
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
              required
              placeholder={t('edit_modal.roles_placeholder')}
            />
          </div>

          <div className="mb-6">
            <label htmlFor="gender" className="block text-sm font-medium text-gray-700 mb-1">{t('edit_modal.gender')}</label>
            <select
              id="gender"
              name="gender"
